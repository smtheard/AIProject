...
game::game(){
    ...
    row1[0]=p;row1[1]=p+1;row1[2]=p+2; //starting from here the pointers arrays correspond to rows1,2,3:cols 1,2,3 nad diagonals 1 & 2 respectively
